...
function (find_cubemx_standalone)
  ...
  find_file(CUBEMX_I NAMES STM32CubeMX STM32CubeMX.exe PATHS $ENV{CUBEMX_DIR} ${CUBEMX_DIR} ${CUBEMX_DEFAULT_DIR_LINUX} ${CUBEMX_DEFAULT_DIR_WINDOWS} ${CUBEMX_REGISTRY_PATH})
  ...
  message(CHECK_PASS "found at ${CUBEMX_I}")
...
function (find_cubemx_cubeide)
  ...
  foreach (CUBEMX_D IN LISTS CUBEMX_DIRS)
    ...
    if (CUBEMX_I)
      ...
      set(CUBEMX "${CUBEMX_D}" CACHE PATH "CubeMX instance")
      break()
    endif ()
  endforeach ()
  ...
  foreach (JRE_D IN LISTS CUBEMX_JRE_DIRS)
    find_file(JRE_EXE java HINTS "${JRE_D}")
    if (JRE_EXE)
      message(CHECK_PASS "found at ${JRE_D}")
      set(CUBEMX_JRE "${JRE_D}" CACHE PATH "CubeMX Java instance")
      break()
    endif ()
  endforeach ()
