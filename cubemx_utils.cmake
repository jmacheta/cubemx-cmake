...
if (NOT CUBEMX)
  ...
  if (${CMAKE_HOST_SYSTEM_NAME} STREQUAL "Windows")
    ...
    get_filename_component(CUBEMX_REGISTRY_PATH "[HKEY_LOCAL_MACHINE\\SOFTWARE\\WOW6432Node\\Microsoft\\Windows\\CurrentVersion\\App Paths\\STM32CubeMX.exe;Path]" DIRECTORY)
    if (EXISTS "${CUBEMX_REGISTRY_PATH}")
      list(APPEND CUBEMX_DEFAULT_DIR_WINDOWS "${CUBEMX_REGISTRY_PATH}")
    endif ()
